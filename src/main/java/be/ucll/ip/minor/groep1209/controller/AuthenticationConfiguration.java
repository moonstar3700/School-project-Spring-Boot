    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                    ...
                    .antMatchers("/clubhuis/overview").permitAll()
                    .antMatchers("/clubhuis/filter").permitAll()
                    .antMatchers("/clubhuis/filterPage").permitAll()
                    .antMatchers("/clubhuis/add").authenticated()
